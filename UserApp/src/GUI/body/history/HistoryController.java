...
import GUI.body.execution.SingleStepExecutionTableData;
...
public class HistoryController extends BodyControllerComponent implements Initializable{
                ...
                outputsListView.getSelectionModel().selectedItemProperty().addListener(((observable, oldValue, newValue) -> {
                        Platform.runLater(() -> {
                                if(newValue != null) {
                                        ...
                                        String outputName = ExecutionController.getStepNameWithoutReadonly(executedStepsStatusListView.getSelectionModel().getSelectedItem().toString());
