...
public class CollectFilesInFolderStep extends AbstractStepDefinition {
    ...
    public StepResult invoke(StepExecutionContext context) {
        ...
        switch (result) {
            ...
            case WARNING:
                ...
                context.storeDataValue(this.outputs().get(1).getName(), 0);
                break;
            case FAILURE:
                break;
        }
    ...
    public StepResult handleSUCCESS(StepExecutionContext context) {
        ...
        if (filesList != null) {
            context.storeDataValue(this.outputs().get(0).getName(), filesList);
            context.storeDataValue(this.outputs().get(1).getName(), filesList.size());
